...
// My Solution
const maxProduct = (numbers, size) => [...numbers].sort((a,b)=>a-b).slice(-size).reduce((acc,rec)=>acc*rec,1)
...
// Another Solution
function maxProduct(numbers, size){
  return numbers.sort((a,b)=>a-b).splice(numbers.length-size).reduce((a,b)=>a*b);
}
