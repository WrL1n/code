...
// My Solution
Array.prototype.square = function () { return this.map(it => it**2) }
Array.prototype.cube = function () { return this.map(it => it**3) }
Array.prototype.sum = function () { return this.reduce((acc, rec) => acc + rec, 0)}
Array.prototype.average = function () { return this.sum() / this.length }
Array.prototype.even = function () { return this.filter(it => it % 2 === 0)}
Array.prototype.odd = function () { return this.filter(it => it % 2 !== 0)}
